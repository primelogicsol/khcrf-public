...
content = content.replace('      {/* Mobile Sidebar Navigation */}', '''      {/* Mobile Sidebar Navigation */}
...
content = content.replace('className="text-xl text-[#050A1E] hover:text-[#CDAC36] transition-all duration-300"', 'className={`text-xl hover:text-[#CDAC36] transition-all duration-300 ${isOverlay ? "text-white" : "text-[#050A1E]"}`}')

content = content.replace('className="flex items-center font-bold text-[16px] uppercase tracking-[0.05em] text-[#050A1E] group-hover:text-[#CDAC36] transition-all duration-300"', 'className={`flex items-center font-bold text-[16px] uppercase tracking-[0.05em] transition-all duration-300 ${isOverlay ? "text-white" : "text-[#050A1E]"} group-hover:text-[#CDAC36]`}')

# Wrap root header with sticky top-0
content = content.replace('className="relative w-full z-[var(--z-header)]"', 'className={`relative w-full z-[var(--z-header)] sticky top-0`}')
