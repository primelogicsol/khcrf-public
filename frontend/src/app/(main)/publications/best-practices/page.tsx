...
import { publicationsBestPracticesHeroFallback } from "@/config/heroFallbacks";
...
export const metadata: Metadata = {
  title: "Best Practices | KHCRF Knowledge Hub",
...
export default async function PublicationsCategoryPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 font-sans flex flex-col">
      <main className="grow">
        <UniversalEditorialHero pageKey="best-practices" fallbackConfig={publicationsBestPracticesHeroFallback as any} />
        ...
        <section className="py-16">
          ...
          >
            <PublicationList
              ...
              defaultCategory="Best Practices"
            />
          </Suspense>
        </section>
