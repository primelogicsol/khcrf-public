...
import { publicationsResearchPapersHeroFallback } from "@/config/heroFallbacks";
...
export const metadata: Metadata = {
  title: "Research Papers | KHCRF Knowledge Hub",
...
export default async function PublicationsCategoryPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 font-sans flex flex-col">
      <main className="grow">
        <UniversalEditorialHero pageKey="research-papers" fallbackConfig={publicationsResearchPapersHeroFallback as any} />
        ...
        <section className="py-16">
          ...
          >
            <PublicationList
              ...
              defaultCategory="Research Papers"
            />
          </Suspense>
        </section>
