...
import { publicationsCaseStudiesHeroFallback } from "@/config/heroFallbacks";
...
export const metadata: Metadata = {
  title: "Case Studies | KHCRF Knowledge Hub",
...
export default async function PublicationsCategoryPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 font-sans flex flex-col">
      <main className="grow">
        <UniversalEditorialHero pageKey="case-studies" fallbackConfig={publicationsCaseStudiesHeroFallback as any} />
