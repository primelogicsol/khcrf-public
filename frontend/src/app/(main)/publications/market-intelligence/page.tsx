...
import { publicationsMarketIntelligenceHeroFallback } from "@/config/heroFallbacks";
...
export const metadata: Metadata = {
  title: "Market Intelligence | KHCRF Knowledge Hub",
...
export default async function PublicationsCategoryPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 font-sans flex flex-col">
      <main className="grow">
        <UniversalEditorialHero pageKey="market-intelligence" fallbackConfig={publicationsMarketIntelligenceHeroFallback as any} />
        ...
        <section className="py-16">
          ...
          >
            <PublicationList
              ...
              defaultCategory="Market Intelligence"
            />
          </Suspense>
        </section>
