...
export default function StakeholderStatementsPage() {
      ...
      <div className="container mx-auto px-4 max-w-5xl">
        ...
        <div className="bg-white p-8 md:p-12 rounded-3xl border border-gray-200 shadow-sm mb-8">
          <div className="mb-10 text-center border-b border-gray-100 pb-10">
            <h1 className="text-3xl md:text-4xl font-black text-brand-dark mb-4">Stakeholder Statements Collection</h1>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Templates and published statements from artisans, exporters, researchers, youth, women, and civil society.
            </p>
          </div>
          ...
          <div className="bg-blue-50 border border-blue-100 p-6 rounded-xl flex gap-4 items-start mb-12">
            ...
            <div>
              ...
              <p className="text-sm text-blue-700">
                The collection is currently gathering stakeholder statements. You may download a template below to prepare your submission.
              </p>
            </div>
          </div>
          ...
          <div className="mb-12">
            ...
            <div className="bg-gray-50 p-6 rounded-xl border border-gray-200">
              ...
              <ul className="list-disc list-inside text-sm text-gray-600 grid grid-cols-1 sm:grid-cols-2 gap-2">
                <li>Full Name</li>
                <li>Stakeholder Category</li>
                <li>District</li>
                <li>Date</li>
                <li>Statement Text</li>
                <li>PDF Upload (Optional)</li>
              </ul>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="py-12 text-center text-gray-500 border-2 border-dashed border-gray-200 rounded-2xl">
              No published stakeholder statements available in this collection yet.
            </div>
          </div>
        </div>
      </div>
