...
export default function GovernmentMessagesPage() {
      ...
      <div className="container mx-auto px-4 max-w-5xl">
        ...
        <div className="bg-white p-8 md:p-12 rounded-3xl border border-gray-200 shadow-sm mb-8">
          <div className="mb-10 text-center border-b border-gray-100 pb-10">
            <h1 className="text-3xl md:text-4xl font-black text-brand-dark mb-4">Government Messages Collection</h1>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Templates and published messages from government offices, departments, and public authorities.
            </p>
          </div>
          ...
          <div className="bg-blue-50 border border-blue-100 p-6 rounded-xl flex gap-4 items-start mb-12">
            ...
            <div>
              ...
              <p className="text-sm text-blue-700">
                The collection is currently gathering official messages. You may download a template below to prepare your submission.
              </p>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="py-12 text-center text-gray-500 border-2 border-dashed border-gray-200 rounded-2xl">
              No published official messages available in this collection yet.
            </div>
          </div>
        </div>
      </div>
