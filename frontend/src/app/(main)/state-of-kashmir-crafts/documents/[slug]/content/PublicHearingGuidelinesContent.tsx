...
import { FaProjectDiagram, FaCheckCircle, FaListUl, FaInfoCircle, FaBullhorn } from "react-icons/fa";

export default function PublicHearingGuidelinesContent() {
  return (
    <div className="prose prose-lg max-w-none text-gray-700">
      ...
      <section className="mb-12">
        ...
        <p className="leading-relaxed bg-white p-6 rounded-2xl border border-gray-100 shadow-sm">
          Public Hearings provide structured opportunities for stakeholders to share perspectives, concerns, priorities, and recommendations.
        </p>
      </section>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
        <section>
          <h2 className="text-2xl font-black text-brand-dark mb-4 flex items-center gap-2">
            <FaBullhorn data-ui-icon  className="" /> Hearing Objectives
          </h2>
          <ul className="space-y-3 pl-0 list-none">
            {["Gather public views", "Encourage transparency", "Identify emerging issues", "Validate stakeholder experiences"].map((item: any) => (
        ...
        <section>
          <h2 className="text-2xl font-black text-brand-dark mb-4 flex items-center gap-2">
            <FaListUl data-ui-icon  className="" /> Hearing Types
          </h2>
          <div className="flex flex-col gap-3">
            {["Craft-specific hearings", "District hearings", "Youth hearings", "Women's participation hearings", "Export and trade hearings"].map((type: any) => (
      ...
      <section className="mb-12">
        <h2 className="text-2xl font-black text-brand-dark mb-8 flex items-center gap-2">
          <FaProjectDiagram data-ui-icon  className="" /> Hearing Workflow
        </h2>
        <div className="bg-white p-8 rounded-2xl border border-gray-100 shadow-sm relative">
           ...
           <div className="space-y-6">
              {[
                { step: "Registration" },
                { step: "Speaker Selection" },
                { step: "Hearing Session" },
                { step: "Recording" },
                { step: "Summary Preparation" },
                { step: "Publication" }
