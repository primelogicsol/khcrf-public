...
export const metadata = {
  title: 'Interviews | Hamadan Craft Revival Foundation',
  ...
  return (
    <main className="bg-[#FAF9F6] min-h-screen text-[#2A2A2A]">
      <section className="pt-32 pb-16 px-4 md:px-10 container-fluid mx-auto universal-hero">
        <h1 className="text-4xl md:text-6xl font-serif text-[#3E2723] mb-6">Interviews</h1>
        <p className="text-xl max-w-3xl">Welcome to the Interviews page.</p>
      </section>
    </main>
  );
}
