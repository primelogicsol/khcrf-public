...
export default function StudioDashboard() {
  const { data, error, isLoading } = useSWR('/api/studio', fetcher);

  if (isLoading) return <div className="p-8">Loading Studios...</div>;
  if (error) return <div className="p-8 text-red-500">Failed to load data.</div>;

  return (
    <div className="p-8 w-full">
      <h1 className="text-2xl font-bold mb-6">Studio Management</h1>
