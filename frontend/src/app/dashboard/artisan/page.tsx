...
export default function ArtisanDashboard() {
  const { data, error, isLoading } = useSWR('/api/artisan', fetcher);

  if (isLoading) return <div className="p-8">Loading Artisans...</div>;
  if (error) return <div className="p-8 text-red-500">Failed to load data.</div>;

  return (
    <div className="p-8 w-full">
      <h1 className="text-2xl font-bold mb-6">Artisan Management</h1>
