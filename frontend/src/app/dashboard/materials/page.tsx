...
export default function MaterialsDashboard() {
  ...
  const { data, error, isLoading, mutate } = useSWR(`/api/material?${query.toString()}`, fetcher);
  const apiEndpoint = `/api/material`;
  ...
  return (
    <div className="p-6 space-y-6">
      <div className="flex justify-between items-center">
        <h1 className="text-3xl font-bold tracking-tight">Material Registry</h1>
