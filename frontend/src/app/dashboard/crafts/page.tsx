...
export default function CraftsDashboard() {
  ...
  const { data, error, isLoading, mutate } = useSWR(`/api/craft?${query.toString()}`, fetcher);
  const apiEndpoint = `/api/craft`;
  ...
  return (
    <div className="p-6 space-y-6">
      <div className="flex justify-between items-center">
        <h1 className="text-3xl font-bold tracking-tight">Craft Directory</h1>
