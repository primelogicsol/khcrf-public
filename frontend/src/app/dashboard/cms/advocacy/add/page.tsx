...
export default function AddAdvocacyPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await initiativeApi.create({
        type: "ADVOCACY", // Changed type to ADVOCACY
      ...
      console.error(error);
      toast.error("Error creating advocacy campaign");
    } finally {
      setLoading(false);
    }
  };
