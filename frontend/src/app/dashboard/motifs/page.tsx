...
export default function MotifsDashboard() {
  ...
  const { data, error, isLoading, mutate } = useSWR(`/api/motif?${query.toString()}`, fetcher);
  const apiEndpoint = `/api/motif`;
  ...
  return (
    <div className="p-6 space-y-6">
      <div className="flex justify-between items-center">
        <h1 className="text-3xl font-bold tracking-tight">Motif Database</h1>
