...
export default function SourcereferencesDashboard() {
  ...
  const { data, error, isLoading } = useSWR(`/api/source-reference?${query.toString()}`, fetcher);
  ...
  return (
    <div className="p-6 space-y-6">
      <div className="flex justify-between items-center">
        <h1 className="text-3xl font-bold tracking-tight">Source References</h1>
