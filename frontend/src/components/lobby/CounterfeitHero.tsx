        ...
        <div className="flex-1 space-y-4">
          <h1 className="text-4xl md:text-5xl font-playfair font-bold leading-tight">
            ...
            <span className="block text-xl md:text-2xl mt-2 font-light text-slate-200 italic">
              Reporting and Tracking Fake Handicraft Products in the
              Constituency
            </span>
          </h1>
          ...
          <div className="pt-4">
            <button className="bg-[#ca8a04] hover:bg-[#a16207] text-white px-8 py-3 rounded-lg font-bold text-lg shadow-lg uppercase tracking-wide flex items-center transition-colors">
              <ShieldAlert size={24} className="mr-3" />
              Report Counterfeit Now
            </button>
          </div>
        </div>
...
export default CounterfeitHero;
