      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 flex flex-col md:flex-row items-center">
        <div className="flex-1 space-y-4">
          <h1 className="text-4xl md:text-5xl font-playfair font-bold leading-tight">
            Legislative Artisan Desk
            <span className="block text-xl md:text-2xl mt-2 font-light text-slate-200">
              Official Public Communications & Verified Updates
            </span>
          </h1>
          <p className="max-w-xl text-lg text-slate-200 italic">
            "Strengthening our handicraft economy through policy oversight and
            stakeholder collaboration."
          </p>
          <div className="pt-2 flex items-center space-x-4 text-sm text-[#ca8a04] font-semibold">
...
export default LegislativeHero;
