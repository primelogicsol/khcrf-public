      ...
      columns: [
        {
          title: "People",
          links: [
            { name: "Kashmir Artisan Registry", href: "/master-artisans" },
            { name: "Master Artisans", href: "/master-artisans/artisans?view=MASTER_ARTISAN" },
            { name: "Living Legends", href: "/master-artisans/artisans?view=LIVING_MASTER" },
            { name: "Women Artisans", href: "/master-artisans/artisans?view=WOMEN_ARTISAN" },
            { name: "Emerging Artisans", href: "/master-artisans/artisans?view=EMERGING_ARTISAN" },
            { name: "Workshop Communities", href: "/master-artisans/artisans?view=WORKSHOP_COMMUNITY" },
          ]
        },
        {
          title: "Studio",
