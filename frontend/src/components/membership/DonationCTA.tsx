                ...
                >
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center relative z-20" style={{ transform: "translateZ(30px)" }}>
                        <div className="space-y-6">
                            ...
                            >
                                Ready to Make an <br />
                                <span className="text-transparent bg-clip-text bg-gradient-to-r from-white via-gray-100 to-gray-300 drop-shadow-md">Impact?</span>
                            </motion.h2>
                            ...
                            >
                                Your contribution directly empowers Kashmiri artisans, preserves centuries-old traditions, and builds a sustainable future for the craft industry.
                            </motion.p>
                        </div>

                        <div className="flex flex-col sm:flex-row gap-6 justify-center lg:justify-end items-center">
                            <Link href="/about/donations/donate">
                                <motion.div
                            ...
                            >
                                ...
                                <p className="opacity-70">Every contribution counts.</p>
                            </motion.div>
                        </div>
                    </div>
                </motion.div>
