...
export default function MembershipCTA() {
    ...
    const joinHref = returnTo
        ? `/about/memberships/join?returnTo=${encodeURIComponent(returnTo)}`
        : "/about/memberships/join";
    ...
    return (
        <section className="py-24 relative overflow-hidden perspective-1000">
            {/* Background */}
            <div className="absolute inset-0 bg-[#050A1E]"></div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center relative z-20" style={{ transform: "translateZ(30px)" }}>
                        <div className="space-y-6">
                            ...
                            >
                                ...
                                <span className="text-transparent bg-clip-text bg-gradient-to-r from-white via-gray-100 to-gray-300 drop-shadow-md">Member?</span>
                            </motion.h2>
                            ...
                            >
                                Join our community today and play a vital role in preserving and promoting Kashmiri heritage. Your contribution directly impacts the lives of artisans and the future of our craft.
                            </motion.p>
                        </div>
                        ...
                        <div className="flex flex-col sm:flex-row gap-6 justify-center lg:justify-end items-center">
                            ...
                            >
                                ...
                                <p className="opacity-70">Impact lasts a lifetime.</p>
                            </motion.div>
                        </div>
                    </div>
                </motion.div>
