        ...
        >
          ...
          >
            <div className="space-y-6">
              ...
              >
                Join Us in <br />
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-white via-gray-100 to-gray-300 drop-shadow-md">
                  Creating a Legacy
                </span>
              </motion.h2>
              ...
              >
                <p className="text-lg text-white/90 leading-relaxed max-w-xl">
                  By becoming a member of the KHCRF Board, you’ll be part of a
                  movement that champions Kashmir’s artisans, preserves a
                  cultural legacy, and pioneers sustainable growth in the global
                  handicraft industry.
                </p>
              </motion.div>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center lg:justify-end items-center">
              <div className="flex flex-col gap-4 text-center sm:text-right">
                <Link href="mailto:board@khcrf.org">
                  <motion.div
                ...
                >
                  <p>Contact: board@khcrf.org</p>
                  <p className="opacity-70">director@khcrf.org</p>
                </motion.div>
              </div>
            </div>
          </div>
