...
# First, let's find the start of the Tasks section
start_marker = "{/* Main Workspace Tasks */}"
end_marker = "</div>\n        </div>\n\n        {/* Support & Quick Links */}"
...
if start_idx == -1 or end_idx == -1:
    ...
    new_tasks = """{/* Main Workspace Tasks */}
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="space-y-1 bg-stone-50 p-3 rounded-xl border border-stone-100">
                      <div className="flex justify-between text-[11px] uppercase tracking-wider font-bold gap-4">
                        ...
                        <span className="text-stone-700 text-right">Srinagar District Consultation Centre</span>
                      </div>
                      <div className="flex justify-between text-[11px] uppercase tracking-wider font-bold">
                        <span className="text-stone-500">Date</span>
                        <span className="text-stone-700">22 September 2026</span>
                      </div>
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="space-y-1 bg-stone-50 p-3 rounded-xl border border-stone-100">
                      <div className="flex justify-between text-[11px] uppercase tracking-wider font-bold gap-4">
                        ...
                        <span className="text-stone-700 text-right">Craft Economy and Artisan Welfare</span>
                      </div>
                      <div className="flex justify-between text-[11px] uppercase tracking-wider font-bold">
                        <span className="text-stone-500">Date</span>
                        <span className="text-stone-700">5 October 2026</span>
                      </div>
                      <div className="flex justify-between text-[11px] uppercase tracking-wider font-bold mt-2 pt-2 border-t border-stone-200">
                        <span className="text-stone-500">Status</span>
                        <span className="text-purple-600">Eligible to Register</span>
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="space-y-1 bg-stone-50 p-3 rounded-xl border border-stone-100">
                      <div className="flex justify-between text-[11px] uppercase tracking-wider font-bold gap-4">
                        ...
                        <span className="text-stone-700 text-right">Artisan Livelihoods and Market Access</span>
                      </div>
                      <div className="flex justify-between text-[11px] uppercase tracking-wider font-bold">
                        <span className="text-stone-500">Deadline</span>
                        <span className="text-stone-700">20 November 2026</span>
                      </div>
                      <div className="flex justify-between text-[11px] uppercase tracking-wider font-bold mt-2 pt-2 border-t border-stone-200">
                        <span className="text-stone-500">Status</span>
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="space-y-1 bg-stone-50 p-3 rounded-xl border border-stone-100">
                      <div className="flex justify-between text-[11px] uppercase tracking-wider font-bold gap-4">
                        ...
                        <span className="text-stone-700 text-right">Traditional Craft Production and Market Systems</span>
                      </div>
                      <div className="flex justify-between text-[11px] uppercase tracking-wider font-bold mt-2 pt-2 border-t border-stone-200">
                        <span className="text-stone-500">Status</span>
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="space-y-1 bg-stone-50 p-3 rounded-xl border border-stone-100">
                      <div className="flex justify-between text-[11px] uppercase tracking-wider font-bold gap-4">
                        ...
                        <span className="text-stone-700 text-right">PDF, DOCX, XLSX, JPG, PNG</span>
                      </div>
                      <div className="flex justify-between text-[11px] uppercase tracking-wider font-bold">
                        <span className="text-stone-500">Maximum Size</span>
                        <span className="text-stone-700">25 MB</span>
                      </div>
                      <div className="flex justify-between text-[11px] uppercase tracking-wider font-bold mt-2 pt-2 border-t border-stone-200">
                        <span className="text-stone-500">Status</span>
