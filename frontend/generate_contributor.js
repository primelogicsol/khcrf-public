...
export default function ContributorWorkflow() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const res = await fetch(\`\${API_BASE_URL}/api/participation/contributor\`, {
        method: 'POST',
            ...
            <div className="bg-gray-50 p-8 rounded-3xl border border-gray-100">
              ...
              <div className="space-y-4">
                {[
                  ...
                  { name: 'declarationRepresentation', label: 'I confirm that I do not misrepresent myself as a government official or HCRF employee without authorisation.' },
...
fs.writeFileSync('C:/Users/Fayaz/Sufipulseupdate2026/HCRF 2026/hcr_foundation_full_govind/frontend/src/app/(main)/master-artisans/contributor/page.tsx', code, 'utf-8');
console.log('done');
