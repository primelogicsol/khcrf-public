...
get_all_logic = """  static async getAll(req: Request, res: Response) {
    try {
      ...
      if (verification && verification !== 'ALL') {
        ...
        if (verification === 'MULTIPLE_GOVT') where.sources = { some: {} }; // Approximation for now
