...
const oldStr = `<span className="text-[10px] font-bold uppercase tracking-wider text-gray-500 block mb-1">Next Hearing</span>
...
console.log('Fixed Next Hearing block!');
